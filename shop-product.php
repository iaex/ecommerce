							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="thumb-gallery-wrapper">
										<div class="thumb-gallery-detail owl-carousel owl-theme manual nav-inside nav-style-1 nav-dark mb-3">
											<div>
												<img alt="" class="img-fluid" src="imgs/picture1.jpg" data-zoom-image="imgs/picture1.jpg">
											</div>
											<div>
												<img alt="" class="img-fluid" src="imgs/picture2.jpg" data-zoom-image="imgs/picture2.jpg">
											</div>
											<div>
												<img alt="" class="img-fluid" src="imgs/picture5.jpg" data-zoom-image="imgs/picture5.jpg">
											</div>
											<div>
												<img alt="" class="img-fluid" src="imgs/picture7.jpg" data-zoom-image="imgs/picture7.jpg">
											</div>
											<!--<div>
										...
										<div class="thumb-gallery-thumbs owl-carousel owl-theme manual thumb-gallery-thumbs">
											<div class="cur-pointer">
												<img alt="" class="img-fluid" src="imgs/picture1.jpg">
											</div>
											<div class="cur-pointer">
												<img alt="" class="img-fluid" src="imgs/picture2.jpg">
											</div>
											<!--<div class="cur-pointer">
												<img alt="" class="img-fluid" src="imgs/picture3.jpg">
											</div>-->
											<div class="cur-pointer">
												<img alt="" class="img-fluid" src="imgs/picture5.jpg">
											</div>
											<div class="cur-pointer">
												<img alt="" class="img-fluid" src="imgs/picture7.jpg">
											</div>
										</div>
									</div>
								...
								<div class="col-lg-6">
									...
									<div class="summary entry-summary position-relative">
										...
										<h1 class="mb-0 font-weight-bold text-7">Cool Cup Water Bottle</h1>
										...
										<p class="price mb-3">
											<span class="sale text-color-dark">550 TK</span>
											<span class="amount">600 TK</span>
										</p>

										<p class="text-3-5 mb-3">Creative Mars Rover Water Cup Fun Boys Portable Straw Cup Children Multifunctional Toys Gift Cups</p>
										...
										<form enctype="multipart/form-data" method="post" class="cart" action="shop-cart.php">
...
<span class="badge badge-ecommerce text-bg-success">NEW</span>
												...
												<div class="addtocart-btn-wrapper">
													<a href="shop-cart.php" class="text-decoration-none addtocart-btn" title="Add to Cart">
											...
											<div class="d-flex justify-content-between">
												<div>
													...
													<h3 class="text-3-5 font-weight-medium font-alternative text-transform-none line-height-3 mb-0"><a href="shop-product-sidebar-right.html" class="text-color-dark text-color-hover-primary">Cool Cup Water Bottle</a></h3>
												</div>
