...
<span class="badge badge-ecommerce text-bg-success">NEW</span>
											...
											<div class="d-flex justify-content-between">
												<div>
													<a href="#" class="d-block text-uppercase text-decoration-none text-color-default text-color-hover-primary line-height-1 text-0 mb-1">Gadget</a>
											...
											<p class="price text-5 mb-3">
												<span class="sale text-color-dark font-weight-semi-bold">550 TK</span>
